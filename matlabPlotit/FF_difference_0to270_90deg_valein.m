...
amp_90 = [amp_90(9871:10011)];
amp_180 = [amp_180(9871:10011)];
amp_270 = [amp_270(9871:10011)];
...
subtitle('Farfield measurement at 75GHz July2023, mask on')
ylim([-160 -100])
legend('Phase 0','Phase 90', 'Phase 180','Phase 270', 'Diff. of Ampl.', 'Location', 'best');
hold off


saveas(gcf,fullfile('VTT_transarray_matlab_pictures', ['Element_', num2str(element_number), '_FF_amplitudes_0_to_270_chessboard_heinakuu_10x10.jpg']));