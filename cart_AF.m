...
% Calculates array factor for MxN array antenna and plots it in cartesian 
% coordinates.
...
theta=linspace(0,2*pi,361*2);
phi=linspace(0,2*pi,361*2);
...
[x,y,z] = sph2cart(PHI,THETA,AF_total);
