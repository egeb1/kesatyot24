...
theta=linspace(-pi/2,pi/2,361*2);
phi=linspace(-pi,pi,361*2);
[THETA,PHI]=meshgrid(theta,phi);

tilt_el =0;   % Phase shift between elements in elevation
tilt_az = 0;   % Phase shift between elements in azimuth
...
min(20*log10(AF_total),[],"all") 
max(20*log10(AF_total),[],"all")